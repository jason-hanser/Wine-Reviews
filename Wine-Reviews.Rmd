...
The SVM model provided a significant increase in accuracy over the lasso method. However, the improved performance came at a cost: speed. I was able to train the lasso models within a couple of hours on my local machine, an old Dell laptop. The SVM on the other hand takes 3-4 days to train on an AWS EC2 instance. 
